        ...
        <div class="main-content">
            <div class="wrapper">
               ...
               <?php 
                    ...
                    if(isset($_SESSION['password-doesnt-match']))
                    {
                        echo $_SESSION['password-doesnt-match'];
                        unset($_SESSION['password-doesnt-match']);
                    }
               ...
               <table class="tbl-full">
                    ...
                    <?php 
                        ...
                        if($res==TRUE)
                        {
                            //count rows to check if the data is in the database 
